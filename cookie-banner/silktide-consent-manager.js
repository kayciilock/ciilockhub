...
class SilktideCookieBanner {
  constructor(config) {
    ...
    // NOTE: cookie icon not created anymore
  ...
  toggleModal(show) {
    ...
    if (show) {
      this.showBackdrop();
      // cookie icon is not used any more
      // this.hideCookieIcon();
      this.removeBanner();
  ...
  setupEventListeners() {
    ...
    // cookieIcon listeners are effectively disabled because we never create it
    if (this.cookieIcon) {
